...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel		jInfoLabel3a			= new JLabel();
	...
	JLabel jInputFilenameLabel0 = new JLabel();
	JTextField jInputFilenameTextField0 = new JTextField();
	...
	private void jbInit() throws Exception {
		...
		jInfoLabel1a.setText("  And was edited by David Anderson for use at Central Coast Printing");
		jInfoLabel2.setForeground(Color.blue);
		jInfoLabel2.setText("http://www.altova.com/mapforce");
		jInfoLabel3a.setText("This program will take all the files listed, process them, then move them to the folder processed with ticket.");
		...
		jHeaderInfo.add(jInfoLabel3a,3);
		jHeaderInfo.add(jInfoLabel3,4);
	...
	protected void fillScrollPane() {
		...
		jInputFilenameLabel0.setText("Input Parameter : InputFilename");
		jInputFilenameLabel0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jInputFilenameLabel0, null);

		jInputFilenameTextField0.setText("" );
		jInputFilenameTextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jInputFilenameTextField0.setEditable(true);
		jInputFilenameTextField0.addKeyListener(new MappingFrame_jInputFilenameTextField0_keyAdapter( this ) );
		jPanelStructures.add(jInputFilenameTextField0, null);
		...
		jText_file2TextField1.setText("Output Text File.txt");
	...
	void jInputFilenameTextField0_actionPerformed( KeyEvent e ) {
		if ( e.getSource().equals( jInputFilenameTextField0 ) ) {
			String value = jInputFilenameTextField0.getText();
			if( value.length() != 0 )
				mapArguments.put( "InputFilename", value );
			else {
				if( mapArguments.containsKey( "InputFilename" ) )
					mapArguments.remove( "InputFilename" );
			}
		}
	}
...
class MappingFrame_jInputFilenameTextField0_keyAdapter
	implements java.awt.event.KeyListener {
	MappingFrame adaptee;

	MappingFrame_jInputFilenameTextField0_keyAdapter( MappingFrame adaptee ) {
		this.adaptee = adaptee;
	}

	public void keyTyped( KeyEvent e ) {
		adaptee.jInputFilenameTextField0_actionPerformed( e );
	}
